...
const CASE_STUDIES = {
  catalyst: {
    ...
    title: 'CATalyst',
    tagline: 'A mistake-fixing system for CAT aspirants. Live with paying users.',
    color: '#2E5BFF',
    ...
    solution: 'Built a "Fix Mode" loop: every wrong answer gets logged, diagnosed, and drilled in a structured re-attempt session. Razorpay payments live — ₹489 one-time or ₹99/month. The paywall shows your own mistake count as the conversion hook.',
    metrics: [
      { val: '794', label: 'Questions live' },
      { val: '7 days', label: 'Free trial' },
      { val: '₹489', label: 'One-time price' },
    ],
    stack: ['Vanilla JS SPA', 'Supabase', 'Razorpay', 'Vercel Serverless', 'Web Push', 'PWA'],
